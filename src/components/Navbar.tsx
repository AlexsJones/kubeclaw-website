        ...
        <div className="flex items-center justify-between h-16">
          ...
          <a href="#" className="flex items-center gap-3 group">
            <div className="relative w-8 h-8 rounded-lg overflow-hidden">
              <img src="/icon.png" alt="KubeClaw" className="w-full h-full object-cover" />
              <div className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-claw-green rounded-full border-2 border-surface animate-pulse" />
            </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-300 hover:text-white rounded-lg hover:bg-white/5 transition-all"
            >
